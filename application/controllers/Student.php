...
class Student extends CI_Controller
{
	...
	*/
		...
		if ($classId) {
            ...
            <div class="tab-content">
              <div role="tabpanel" class="tab-pane active" id="classStudent">
                ...
                <table class="table table-bordered table-hover" id="manageStudentTable">
                  <thead>
                    <tr>
                      <th>#</th>
                      <th>Name</th>
			...
			foreach ($sectionData as $key => $value) {
				$tab['html'] .= '<div role="tabpanel" class="tab-pane" id="countSection' . $x . '">
						...
						<table class="table table-hover table-bordered classSectionStudentTable" id="manageStudentTable' . $x . '" style="width:100%;">
		                  <thead>
		                    <tr>
		                      <th>#</th>
		                      <th>Name</th>
			...
			foreach ($studentData as $key => $value) {
				...
				$button = '<div class="btn-group">
				  ...
				  <ul class="dropdown-menu">			  	
					...
					<li><a type="button" data-toggle="modal" data-target="#viewStudentModal" onclick="viewStudent(' . $value['student_id'] . ')"> <i class="glyphicon glyphicon-edit"></i> View</a></li>
					<li><a type="button" href="javascript:void(0)" title="pdf" onclick="viewPdfstudent(' . $value['student_id'] . ')"> <i class="glyphicon glyphicon-edit"></i> PDF</a></li>		    
				  </ul>
				</div>';
	...
	{
		$data['output'] = $this->model_student->fetchStudentData($studentId);
