	...
	public function fetchSubjectTable($classId = null)
	{
		if($classId) {
			...
			<div class="pull pull-right">
	  			<button class="btn btn-success" data-toggle="modal" data-target="#addSubjectModal" onclick="addSubject('.$classId.')">Add Subject</button>	
		  	</div>
		  		
		  	<br /> <br />

		  	<!-- Table -->
		  	<table class="table table-hover table-bordered" id="manageSubjectTable">
			    <thead>	
			    	<tr>
			    		<th> Subject Name </th>			    		
			    		<th> Teacher Name  </th>
