	...
	public function fetchSectionTable($classId = null)
	{
		if($classId) {
			...
			<div class="pull pull-right">
	  			<button class="btn btn-success" data-toggle="modal" data-target="#addSectionModal" onclick="addSection('.$classId.')">Add Section</button>	
		  	</div>
		  		
		  	<br /> <br />

		  	<!-- Table -->
		  	<table class="table table-bordered table-hover" id="manageSectionTable">
			    <thead>	
			    	<tr>
			    		<th> Section Name </th>
			    		<th> Teacher Name  </th>
